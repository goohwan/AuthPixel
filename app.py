...
translations = {
    "en": {
        ...
        "watermark_limitation": "⚠️ AuthPixel watermarks may be damaged by excessive editing. (Crop: 75%, JPEG: 99%, Resize: 0%)",
    ...
    "ko": {
        ...
        "watermark_limitation": "⚠️ AuthPixel의 워터마크는 과도한 편집 시에는 훼손될 수 있습니다. (이미지 자르기: 75%, JPEG 압축: 99%, 사이즈 변경: 0%)",
